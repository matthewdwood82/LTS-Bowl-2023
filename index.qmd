...
execute:
  ...
  warning: false
---
# NOTE: Results are final for Week 1. Work in progress to report correct best ball results, first only TUE AM when Sleeper rosters finalize, then "live" after each slate once we have logic to slot players and calculate score. Transactions will still report daily. Thanks for your patience.  
```{r dependencies}
...
# current week
this_week <- difftime(lubridate::now(), lubridate::ymd("2023-09-05"), units = "weeks") %>% ceiling() %>% as.integer()
